            ...
            if(ret == 0 && readed == 4ULL) {
                ...
                if(ret == 0 && pos == (u64) offset_fw) {
                    ...
                    if(ret == 0 && readed == 0x2ULL) {
                        ...
                        if(ret == 0 && firmware >= 0x421C && firmware < 0x481C && ver > fw_421 && ver <= fw_481 && ver > cur_firm) {
...
void patch_error_09( const char *path )
{
    ...
    if(firmware < 0x421C || firmware >= 0x481C) return;
...
void copy_usb_to_iris(char * path)
{
    ...
    n+= 47;
    sprintf(name, "/dev_usb00%c/play", n);
    ...
    sprintf(filename, "/dev_usb/play %s Gamesonic Manager?\nVol: %1.2f MB", 
                        language[GLUTIL_WTO], 
    ...
    if(dialog_action == 1) {
        ...
        DPrintf("%s %s\n %s %s\n\n", language[GAMECPYSL_STARTED], "USB", language[GLUTIL_WTO], "Gamesonic Manager");
...
int off[354] = {
    0x00, 0x50, 0x53, 0x46, 0x01, 0x01, 0x00, 0x00, 0xd4, 0x00, 0x00, 0x00, 0x50, 0x01, 0x00, 0x00, 
    0x0c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x02, 0x06, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 
    ...
    
};

int on[386] = {
    
};

void priority_on_off()
{
    FILE *param;
    char buffer1;
    int n, length, pos[3];

    sprintf(temp_buffer, "%s/PARAM.SFO", self_path);
    param = fopen(temp_buffer, "rb");
    fseek(param, 12, SEEK_SET);
    fread(&buffer1, sizeof(buffer1), 1, param);
    ...
    length = ftell(param) - pos[1];
    fseek(param, pos[1], SEEK_SET);
    char buffer2[length];

    for(n = 0; n < length; n++) {
	fread(&buffer2[n], sizeof(buffer2[n]), 1, param);
    }

    fclose(param);

    param = fopen(temp_buffer, "wb");
	...
	fwrite(&buffer1, sizeof(buffer1), 1, param);
    }

    for(n = 0; n < length; n++) {
	fwrite(&buffer2[n], sizeof(buffer2[n]), 1, param);
    }
