...
#define SYSCALL_BASE                    0x8000000000363BE0ULL // 4.80 CEX
...
static inline void remove_lv2_memcpy()
{
    ...
    /* restore syscall */
    //remove_new_poke();
// Found @ 0x2A1474 This is per FW, syscall_rmdir_desc // SC813 // Same as 4.75-4.78
...
//Remove Lv2 memory protection, NOT needed for REBUG 4.7x
    ...
    */
    ...
    //_poke32(0x2975B4, 0xF821FF61); // free openhook Rogero 4.30 (put "stdu    %sp, -0xA0(%sp)" instead   "b       sub_2E9F98")
