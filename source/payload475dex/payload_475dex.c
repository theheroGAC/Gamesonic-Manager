...
int is_firm_475dex(void)
{
   ...
   if(toc == 0x80000000003758E0ULL && peekq(0x800000000031EF48ULL) == 0x323031352F30342FULL)
   {
      return 1;
   }
   else
...
int is_firm_476dex(void)
{
   ...
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x80000000003758E0ULL && peekq(0x800000000031EF48ULL) == 0x323031352F30382FULL)
   {
      return 1;
   }
   else
...
int is_firm_478dex(void)
{
   ...
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x80000000003758E0ULL && peekq(0x800000000031EF48ULL) == 0x323031352F31322FULL)
   {
      return 1;
   }
   else
...
static inline void remove_lv2_memcpy()
{
    ...
    /* restore syscall */
    //remove_new_poke();
// Found @ 0x2BC624 This is per FW, syscall_rmdir_desc // SC813
