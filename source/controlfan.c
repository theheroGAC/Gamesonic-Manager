...
{
    if(firmware == 0x341C || firmware == 0x355C || firmware == 0x355D|| firmware == 0x421C || firmware == 0x421D || firmware == 0x430C || firmware == 0x430D || firmware == 0x431C || firmware == 0x440C
    || firmware == 0x441C || firmware == 0x441D || firmware == 0x446C || firmware == 0x446D || firmware == 0x450C || firmware == 0x450D || firmware == 0x453C || firmware == 0x453D || firmware == 0x455C
    || firmware == 0x455D || firmware == 0x460C || firmware == 0x465C || firmware == 0x465D || firmware == 0x466C || firmware == 0x466D || firmware == 0x470C  || firmware == 0x470D || firmware == 0x475C
    || firmware == 0x475D || firmware == 0x476C || firmware == 0x476D || firmware == 0x478C || firmware == 0x478D || firmware == 0x480C || firmware == 0x480D || firmware == 0x481C || firmware == 0x481D) return 1;
...
set_control_datas:
    ...
    sleep(1);
     ...
     if(firmware == 0x341C) { // firmware 3.41 2EB128
        ...
        ret = 1;
    } else if(firmware == 0x475C || firmware == 0x476C || firmware == 0x478C || firmware == 0x481C) { // firmware 4.75 - 4.76 - 4.78 - 4.81
        ...
        ret = 1;
    } else if(firmware == 0x475D || firmware == 0x476D || firmware == 0x478D || firmware == 0x481D) { // firmware 4.75 - 4.76 - 4.78 - 4.81 DEX
        ...
        ret = 1;
    } else if(firmware == 0x480C) { // firmware 4.80
        ...
        ret = 1;
    } else if(firmware == 0x480D) { // firmware 4.80 DEX
...
static u32 speed_table[8] = {
    0x6B,     // sm_shutdown / manual mode
    0x50,     // < temp_control0
    0x60,     // temp_control0 => temp_control1
    0x68,     // temp_control0 <= temp_control1
    0x70,     // >= temp_control1
    0x78,     // >= temp_control2
    0x80,     // >= temp_control3
    0xA0     // >= temp_control4
...
static u32 speed_table_profile1[8] = {
    0x5F,     // sm_shutdown / manual mode
    0x40,     // < temp_control0
    0x50,     // temp_control0 => temp_control1
    0x58,     // temp_control0 <= temp_control1
    0x60,     // >= temp_control1
    0x68,     // >= temp_control2
    0x70,     // >= temp_control3
    0xA0     // >= temp_control4
...
static u32 temp_control_profile1[5] = {
    62,
    68,
    70,
    72,
...
static u32 speed_table_profile2[8] = {
    0x5F,     // sm_shutdown / manual mode
    0x4D,     // < temp_control0
...
static u32 temp_control_profile2[5] = {
    62,
    68,
    70,
    72,
...
static u32 speed_table_profile3[8] = {
    0x6B,     // sm_shutdown / manual mode
    0x50,     // < temp_control0
    0x60,     // temp_control0 => temp_control1
    0x68,     // temp_control0 <= temp_control1
...
static u32 temp_control_profile3[5] = {
    62,
    68,
    70,
    72,
...
static u32 speed_table_profile4[8] = {
    0x74,     // sm_shutdown / manual mode
    0x58,     // < temp_control0
    0x60,     // temp_control0 => temp_control1
    0x70,     // temp_control0 <= temp_control1
    0x78,     // >= temp_control1
    0x80,     // >= temp_control2
    0x88,     // >= temp_control3
    0xA0     // >= temp_control4
...
static u32 temp_control_profile4[5] = {
    58,
    66,
    68,
    70,
...
static u32 speed_table_profile5[8] = {
    0x84,     // sm_shutdown / manual mode
    0x60,     // < temp_control0
    0x68,     // temp_control0 => temp_control1
    0x70,     // temp_control0 <= temp_control1
    0x78,     // >= temp_control1
...
static u32 temp_control_profile5[5] = {
    58,
    62,
    65,
    68,
...
void draw_controlfan_options()
{
    ...
    if(fanvalues == 0) {
        x2=DrawButton1_UTF8(x + 360, y2, 212, "Fan Profile", (flash && select_option == 15)) + 8; }
    else if(fanvalues == 1) {
        x2=DrawButton1_UTF8(x + 360, y2, 212, "Profile 2", (flash && select_option == 15)) + 8; }
    else if(fanvalues == 2) {
        x2=DrawButton1_UTF8(x + 360, y2, 212, "Profile 3", (flash && select_option == 15)) + 8; }
    else if(fanvalues == 3) {
        x2=DrawButton1_UTF8(x + 360, y2, 212, "Profile 4", (flash && select_option == 15)) + 8; }
    else if(fanvalues == 4) {
        x2=DrawButton1_UTF8(x + 360, y2, 212, "Profile 5", (flash && select_option == 15)) + 8; }
    else {
        x2=DrawButton1_UTF8(x + 360, y2, 212, "Profile 1", (flash && select_option == 15)) + 8; }
    ...
    if(new_pad & (BUTTON_L1 | BUTTON_CIRCLE)) {
    ...
    if(new_pad & BUTTON_CROSS) {
		...
		break;
            ...
            case 15:
                if(fanvalues == 5) {
		    fanvalues = 1;
		    memcpy((void *) temp_control, (void *) temp_control_profile2, sizeof(temp_control));
                    memcpy((void *) speed_table, (void *) speed_table_profile2, sizeof(speed_table)); }
		else if(fanvalues == 1) {
		    fanvalues = 2;
		    memcpy((void *) temp_control, (void *) temp_control_profile3, sizeof(temp_control));
                    memcpy((void *) speed_table, (void *) speed_table_profile3, sizeof(speed_table)); }
		else if(fanvalues == 2) {
		    fanvalues = 3;
		    memcpy((void *) temp_control, (void *) temp_control_profile4, sizeof(temp_control));
                    memcpy((void *) speed_table, (void *) speed_table_profile4, sizeof(speed_table)); }
		else if(fanvalues == 3) {
		    fanvalues = 4;
		    memcpy((void *) temp_control, (void *) temp_control_profile5, sizeof(temp_control));
                    memcpy((void *) speed_table, (void *) speed_table_profile5, sizeof(speed_table)); }
		else {
		    fanvalues = 5;
		    memcpy((void *) temp_control, (void *) temp_control_profile1, sizeof(temp_control));
                    memcpy((void *) speed_table, (void *) speed_table_profile1, sizeof(speed_table)); }
