...
#define SYSCALL_BASE                    0x8000000000363B60ULL //done
#define NEW_POKE_SYSCALL                813
#define NEW_POKE_SYSCALL_ADDR           0x80000000002A1408ULL  // peek(SYSCALL_BASE + NEW_POKE_SYSCALL*8) -> peek(0x363B60 + 813*8)
...
void load_payload_470(int mode)
{
    ...
    */
    ...
    PATCH_JUMP(0x56604, 0x566A0);             // Original: 0x2F840004409C0048ULL -> 0x2F84000448000098ULL
