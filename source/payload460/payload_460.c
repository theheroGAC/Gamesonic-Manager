...
#define UMOUNT_SYSCALL_OFFSET           (0x1A5654 + 0x8) // SYSCALL (838)
...
#define OFFSET_FIX_3C	 0x26FDD8
#define OFFSET_FIX_17	 0x058DAC
#define OFFSET_FIX_2B	 0x055C58
#define OFFSET_FIX	 0x056588
#define OFFSET_2_FIX	 0x05A658
...
_poke32	(OFFSET_FIX - 0xE4 , 0x3BE00000); // error 02
_poke32	(OFFSET_FIX + 0x70 , 0x3BE00000); // error 0F
_poke32	(OFFSET_FIX + 0x140 , 0x3BE00000); // error 09
_poke32	(OFFSET_FIX + 0x14C , 0x3BE00000); // error 04

_poke	(OFFSET_FIX_3C	 , 0x386000007C6307B4); // error 3C
_poke32	(OFFSET_FIX_3C + 0x8	, 0x4E800020	 ); // error 3C

_poke32	(OFFSET_FIX_17	 , 0x60000000	 ); // error 17

_poke	(OFFSET_FIX_2B	 , 0x386000004E800020); // error 2B
