...
void load_payload_465dex (int mode)
{
    ...
    */
	...
	pokeq(0x80000000002367CCULL, 0x38600000F8690000ULL ); // fix 80010017 and 8001002B errors

	pokeq(0x800000000005962CULL, 0xF821FE917C0802A6ULL ); // just restore to original
	pokeq(0x800000000005C780ULL, 0x419E0038E8610098ULL ); // just restore to original
...
/*#define OFFSET_FIX	 0x05658C  // is the same function of offsets of Master Deank
