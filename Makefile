...
SOURCES		+=  source/payload341 source/payload355 source/payload355dex source/payload421 source/payload421dex source/payload430 source/payload430dex source/payload431 source/payload440
SOURCES		+=  source/payload441 source/payload441dex source/payload446 source/payload446dex source/payload450 source/payload450dex source/payload453 source/payload453dex source/payload455
SOURCES		+=  source/payload455dex source/payload460 source/payload465 source/payload465dex source/payload470 source/payload470dex source/payload475 source/payload475dex source/payload480
SOURCES		+=  source/payload480dex source/payload481dex
DATA		:=  datas
SHADERS		:=  shaders
INCLUDES	:=  include include/ftp
INCLUDES	+=  include/payload341 include/payload355 include/payload355dex include/payload421 include/payload421dex include/payload430 include/payload430dex include/payload431 include/payload440
INCLUDES	+=  include/payload441 include/payload441dex include/payload446 include/payload446dex include/payload450 include/payload450dex include/payload453 include/payload453dex include/payload455
INCLUDES	+=  include/payload455dex include/payload460 include/payload465 include/payload465dex include/payload470 include/payload470dex include/payload475 include/payload475dex include/payload480
INCLUDES	+=  include/payload480dex include/payload481dex
...
pkg: $(BUILD) #$(OUTPUT).pkg
	...
	$(VERB) cp -f $(CURDIR)/$(TARGET).self $(BUILDDIR)/pkg/USRDIR/play_manager.self
	...
	$(VERB) $(PKG) --contentid $(CONTENTID) $(BUILDDIR)/pkg/ "$(TITLE)".pkg >> /dev/null
